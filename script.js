...
const dataMagang = [
    ...
    { id: 2, nama: "M Fadly", sekolah: "SMK 5 Gowa", posisi: "TKJ (Teknik Komputer dan Jaringan)", bio: "Mahir Melakukan Fusion Splicing.", ig: "https://www.instagram.com/mfaaadlyv_?igsi=MWJ1bDFlN3o2N200dQ==", tiktok: "#", foto: "fotoanakmagang/fadly.jpeg" },
    { id: 3, nama: "Nursyila Putri", sekolah: "SMKN 3 Bone", posisi: "TKJ (Teknik Komputer dan Jaringan))", bio: "Memiliki kemampuan dalam fotografi, pengambilan gambar, pengaturan komposisi dan pencahayaan, serta editing foto dasar.", ig: "https://www.instagram.com/0lippp.__?igsi=dGptdXB6NmNvM2xi&utm_source=qr", tiktok: "https://www.tiktok.com/@nrsylaaa.__", foto: "fotoanakmagang/olip.jpeg" },
    { id: 4, nama: "IZATULLAH SEFIRA", sekolah: "SMKN 3 Bone", posisi: "TKJ (Teknik Komputer dan Jaringan)", bio: "Ahli dalam instalasi, krimping, dan pengujian kabel UTP (cat 5) (Straight & Crossover).", ig: "https://www.instagram.com/izatul_17?igsi=c3R3MGs5dDQ4eWV2", tiktok: "https://www.tiktok.com/@fiksizasi?_r=1&_t=ZS-99RIK3KMREI", foto: "fotoanakmagang/iza.jpeg" },
    { id: 5, nama: "Dhamar Yoga Septiansyah", sekolah: "SMKN 5 Gowa", posisi: "TKJ (Teknik Komputer dan Jaringan) ", bio: "memiliki sedikit kemampuan menyeting mikrotik, dll.", ig: "https://www.instagram.com/dhayoga_?igsi=MThtYmowY296bWViYg==", tiktok: "#", foto: "fotoanakmagang/damar.jpeg" },
    { id: 6, nama: "[Nama Teman 6]", sekolah: "Asal Sekolah", posisi: "Posisi Magang", bio: "memiliki sedikit kemampuan menyeting mikrotik, dll.", ig: "#", tiktok: "#", foto: "fotoanakmagang/ucok.jpeg" },
    { id: 7, nama: "PRATIWI", sekolah: "SMKN 3 Bone", posisi: "TKJ (Teknik Komputer dan Jaringan)", bio: "krimping kabel dan mc.", ig: "https://www.instagram.com/wi_wi_wi_wii___?igsi=emgzMGk5bTVsbWJ2", tiktok: "https://www.tiktok.com/@qiqiqi144", foto: "fotoanakmagang/wiwi.jpeg" },
    { id: 8, nama: "[Nama Teman 8]", sekolah: "Asal Sekolah", posisi: "Posisi Magang", bio: "Tulis biodata singkat di sini.", ig: "#", tiktok: "#", foto: "https://placehold.co/400x400/e2e8f0/475569?text=FOTO+8" },
    { id: 9, nama: "[Nama Teman 9]", sekolah: "Asal Sekolah", posisi: "Posisi Magang", bio: "Tulis biodata singkat di sini.", ig: "#", tiktok: "#", foto: "https://placehold.co/400x400/e2e8f0/475569?text=FOTO+9" }
];
...
function renderUI() {
    ...
    if (gridIntern) {
        ...
        gridIntern.innerHTML = htmlIntern;
        
        // PENCEGAHAN ERROR: Cek apakah library VanillaTilt ada sebelum dipanggil
        if (typeof VanillaTilt !== 'undefined') {
            VanillaTilt.init(document.querySelectorAll("[data-tilt]"));
        } else {
            console.warn("Library VanillaTilt belum dimuat. Pastikan tag script VanillaTilt ada di HTML.");
        }
    }
    ...
    if (gridGallery) {
        ...
        gridGallery.innerHTML = htmlGallery;
    }
}
...
// Gunakan DOMContentLoaded agar script menunggu seluruh struktur HTML dimuat sempurna
