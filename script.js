...
const dataMagang = [
    ...
    { id: 5, nama: "Dhamar Yoga Septiansyah", sekolah: "SMKN 5 Gowa", posisi: "TKJ (Teknik Komputer dan Jaringan) ", bio: "Tulis biodata singkat di sini.", ig: "#", tiktok: "#", foto: "https://placehold.co/400x400/e2e8f0/475569?text=FOTO+5" },
    { id: 6, nama: "[Nama Teman 6]", sekolah: "Asal Sekolah", posisi: "Posisi Magang", bio: "memiliki sedikit kemampuan menyeting mikrotik, dll.", ig: "#", tiktok: "#", foto: "https://placehold.co/400x400/e2e8f0/475569?text=FOTO+6" },
    { id: 7, nama: "PRATIWI", sekolah: "SMKN 3 Bone", posisi: "NOC (Network Operation Center)", bio: "krimping kabel dan mc.", ig: "https://www.instagram.com/wi_wi_wi_wii___?igsi=emgzMGk5bTVsbWJ2", tiktok: "https://www.tiktok.com/@qiqiqi144", foto: "fotoanakmagang/wiwi.jpeg" },
